...
module.exports = {
    ...
    Hashir: process.env.TAG_REPLY === undefined ? '916235199845@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'LIZA MWOL' : process.env.BOT_NAME,
    ...
    TAGPLK: process.env.TAG_HEADER === undefined ? 'Liza' : process.env.TAG_HEADER,
